...
export const Contact: React.FC = () => {
  return (
    <footer id="contact" className="relative h-screen flex flex-col justify-center items-center py-0 px-6 bg-surface overflow-hidden">
      <div className="container mx-auto max-w-5xl relative z-10 flex flex-col justify-center h-full">
        ...
        <div className="flex-1 flex flex-col justify-center items-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-3xl">
            {/* LinkedIn */}
            <a href="https://www.linkedin.com/in/a-adarsh-jagannath" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 p-6 bg-muted/5 border border-muted/10 rounded-2xl hover:bg-muted/10 hover:border-muted/20 transition-all group">
            ...
            {/* Twitter */}
            <a href="https://x.com/codexaaj" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 p-6 bg-muted/5 border border-muted/10 rounded-2xl hover:bg-muted/10 hover:border-muted/20 transition-all group">
            ...
            {/* Substack */}
            <a href="https://substack.com/@aadarshjagannath?" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 p-6 bg-muted/5 border border-muted/10 rounded-2xl hover:bg-muted/10 hover:border-muted/20 transition-all group">
            ...
            {/* Gmail */}
            <a href="mailto:adarsh.aajkadev@gmail.com" className="flex items-center gap-4 p-6 bg-muted/5 border border-muted/10 rounded-2xl hover:bg-muted/10 hover:border-muted/20 transition-all group">
          ...
          <div className="mt-16 text-center">
            <h3 className="text-7xl md:text-9xl font-bold text-text select-none tracking-tighter">
              LET'S CONNECT
            </h3>
          </div>
        </div>

        <div className="absolute bottom-6 left-0 w-full text-center text-xs text-muted/50">
